...
static const char kKeyChainUDIDAccessGroup[] = "123456.com.trex.ik";
...
char * GetUDIDFromKeyChain()
{
    NSString *s = [SvUDIDTools getUDIDFromKeyChain];
    if (s)
        return MakeStringCopy(s);
    return MakeStringCopy( @"" );
}
...
bool RemoveUDIDFromKeyChain()
{
    bool s = [SvUDIDTools removeUDIDFromKeyChain];
    return s;
}

bool UpdateUDIDInKeyChain(char *str)
{
    NSString * ss = [NSString stringWithFormat:@"%s", str];
    bool s = [SvUDIDTools updateUDIDInKeyChain:ss];
    return s;
}

bool SettUDIDToKeyChain(char *str)
{
    NSString * ss = [NSString stringWithFormat:@"%s", str];
    bool s = [SvUDIDTools settUDIDToKeyChain:ss];
    return s;
}
